...
#Modify for LINUX_VERSION have underline, Sean@liteon, 2013-04-22----->
#KERNEL_BASE=$(firstword $(subst -, ,$(LINUX_VERSION)))
LINUX_BASE=$(firstword $(subst _, ,$(LINUX_VERSION)))
KERNEL_BASE=$(firstword $(subst -, ,$(LINUX_BASE)))
#<-----Sean@liteon, 2013-04-22
...
# Used for comparing the kernel version,<Sean@Liteon.com>, 2014.02.19
LINUX_MAJOR:=$(firstword $(call split_version,$(KERNEL_PATCHVER)))
LINUX_MINOR:=$(word 2,$(call split_version,$(KERNEL_PATCHVER)))
LINUX_SUBLEVEL:=$(lastword $(call split_version,$(KERNEL_PATCHVER)))

# Usage $(call kernel_version)
kernel_version=$(shell bash $(TOPDIR)/scripts/kernel-version.sh $(1) $(2) $(3))

# Usage:  $(call kernel_ifversion, -lt, 030210)
kernel_ifversion=$(shell [ $(call kernel_version, $(LINUX_MAJOR), $(LINUX_MINOR), $(LINUX_SUBLEVEL)) $(1) $(2) ] && echo y)
