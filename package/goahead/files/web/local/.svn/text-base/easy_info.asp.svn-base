...
var wlanScheduleEnable=<% getCfgZero(1, "WiFiScheduleEnable"); %>;
var wlan5GScheduleEnable=<% getCfgZero(1, "WiFi5GScheduleEnable"); %>;
var tmpValue=wlanScheduleEnable || wlan5GScheduleEnable;
var button_status=new Array(6);
if ("<% QoSGetInfo("ez_game_eng"); %>"=="checked")
button_status[0]=1;
else
button_status[0]=0;
button_status[1]=tmpValue;
