...
#else
int BTH_MIN_NUMBER_OF_FRAMES=3;
#endif
/*daniel modify end*/
...
int global_analysis_count =0;
int total_frame = 0;

void spectral_print_data(struct ss *bd)
{
   // int i,ilen;
   // int *p;
    static int once=0;
  ...
  printf(" dynamic_ht2040_en = %d\r\n", bd->dynamic_ht2040_en);
  printf(" dc_index = %d\r\n", bd->dc_index);
  printf(" b_chan_in_mhz = %d\r\n", bd->b_chan_in_mhz);
  printf(" lwr_band_data = %d\r\n", bd->lwr_band_data);
  printf(" previous_nb = %d\r\n", bd->previous_nb);
  printf(" previous_wb = %d\r\n", bd->previous_wb);
  printf(" max_bin = %d\r\n", bd->max_bin);
  printf(" min_bin = %d\r\n", bd->min_bin);
  printf(" wideband = %d\r\n", bd->wideband);
  printf(" narrowband = %d\r\n", bd->narrowband);
  printf(" peak_index = %d\r\n", bd->peak_index);
  printf(" current_burst_width = %d\r\n", bd->current_burst_width);
  printf(" current_burst_rssi = %d\r\n", bd->current_burst_rssi);
  printf(" current_burst_start_time = %d\r\n", bd->current_burst_start_time);
  printf(" current_burst_stop = %d\r\n", bd->current_burst_stop);
  printf(" current_burst_width_wb = %d\r\n", bd->current_burst_width_wb);
  printf(" current_burst_rssi_wb = %d\r\n", bd->current_burst_rssi_wb);
  printf(" current_burst_wb_sum1 = %d\r\n", bd->current_burst_wb_sum1);
  printf(" current_burst_wb_sum2 = %d\r\n", bd->current_burst_wb_sum2);
  printf(" current_burst_wb_sum3 = %d\r\n", bd->current_burst_wb_sum3);
  printf(" current_burst_wb_sum4 = %d\r\n", bd->current_burst_wb_sum4);
  printf(" current_burst_start_time_wb = %d\r\n", bd->current_burst_start_time_wb);
  printf(" current_burst_stop_wb = %d\r\n", bd->current_burst_stop_wb);
  printf(" num_identified_bursts = %d\r\n", bd->num_identified_bursts);
  printf(" num_identified_short_bursts = %d\r\n", bd->num_identified_short_bursts);
  printf(" do_burst_check = %d\r\n", bd->do_burst_check);
  printf(" do_burst_check_wb = %d\r\n", bd->do_burst_check_wb);
  printf(" burst_frequency = %d\r\n", bd->burst_frequency);
  printf(" burst_width = %d\r\n", bd->burst_width);
  printf(" burst_start = %d\r\n", bd->burst_start);
  printf(" burst_stop = %d\r\n", bd->burst_stop);
  printf(" burst_rssi = %d\r\n", bd->burst_rssi);
  printf(" burst_previous_nb = %d\r\n", bd->burst_previous_nb);
  printf(" burst_max_min = %d\r\n", bd->burst_max_min);
  printf(" burstprev1_frequency = %d\r\n", bd->burstprev1_frequency);
  printf(" burstprev1_width = %d\r\n", bd->burstprev1_width);
  printf(" burstprev1_start = %d\r\n", bd->burstprev1_start);
  printf(" burstprev1_rssi = %d\r\n", bd->burstprev1_rssi);
  printf(" burstprev1_previous_nb = %d\r\n", bd->burstprev1_previous_nb);
  printf(" burstprev2_frequency = %d\r\n", bd->burstprev2_frequency);
  printf(" burstprev2_width = %d\r\n", bd->burstprev2_width);
  printf(" burstprev2_start = %d\r\n", bd->burstprev2_start);
  printf(" burstprev2_rssi = %d\r\n", bd->burstprev2_rssi);
  printf(" burstprev2_previous_nb = %d\r\n", bd->burstprev2_previous_nb);
  printf(" burstprev3_frequency = %d\r\n", bd->burstprev3_frequency);
  printf(" burstprev3_width = %d\r\n", bd->burstprev3_width);
  printf(" burstprev3_start = %d\r\n", bd->burstprev3_start);
  printf(" burstprev3_rssi = %d\r\n", bd->burstprev3_rssi);
  printf(" burstprev3_previous_nb = %d\r\n", bd->burstprev3_previous_nb);
  printf(" burstprev1_max_min = %d\r\n", bd->burstprev1_max_min);
  printf(" burstprev2_max_min = %d\r\n", bd->burstprev2_max_min);
  printf(" burstprev3_max_min = %d\r\n", bd->burstprev3_max_min);
  printf(" burstprev1_stop = %d\r\n", bd->burstprev1_stop);
  printf(" burstprev2_stop = %d\r\n", bd->burstprev2_stop);
  printf(" sburst_frequency = %d\r\n", bd->sburst_frequency);
  printf(" sburst_width = %d\r\n", bd->sburst_width);
  printf(" sburst_start = %d\r\n", bd->sburst_start);
  printf(" sburst_stop = %d\r\n", bd->sburst_stop);
  printf(" sburst_rssi = %d\r\n", bd->sburst_rssi);
  printf(" sburst_previous_nb = %d\r\n", bd->sburst_previous_nb);
  printf(" sburst_max_min = %d\r\n", bd->sburst_max_min);
  printf(" sburstprev1_frequency = %d\r\n", bd->sburstprev1_frequency);
  printf(" sburstprev1_width = %d\r\n", bd->sburstprev1_width);
  printf(" sburstprev1_start = %d\r\n", bd->sburstprev1_start);
  printf(" sburstprev1_rssi = %d\r\n", bd->sburstprev1_rssi);
  printf(" sburstprev1_previous_nb = %d\r\n", bd->sburstprev1_previous_nb);
  printf(" sburstprev2_frequency = %d\r\n", bd->sburstprev2_frequency);
  printf(" sburstprev2_width = %d\r\n", bd->sburstprev2_width);
  printf(" sburstprev2_start = %d\r\n", bd->sburstprev2_start);
  printf(" sburstprev2_rssi = %d\r\n", bd->sburstprev2_rssi);
  printf(" sburstprev2_previous_nb = %d\r\n", bd->sburstprev2_previous_nb);
  printf(" sburstprev3_frequency = %d\r\n", bd->sburstprev3_frequency);
  printf(" sburstprev3_width = %d\r\n", bd->sburstprev3_width);
  printf(" sburstprev3_start = %d\r\n", bd->sburstprev3_start);
  printf(" sburstprev3_rssi = %d\r\n", bd->sburstprev3_rssi);
  printf(" sburstprev3_previous_nb = %d\r\n", bd->sburstprev3_previous_nb);
  printf(" sburstprev1_max_min = %d\r\n", bd->sburstprev1_max_min);
  printf(" sburstprev2_max_min = %d\r\n", bd->sburstprev2_max_min);
  printf(" sburstprev1_stop = %d\r\n", bd->sburstprev1_stop);
  printf(" burst0_freq_bin = %d\r\n", bd->burst0_freq_bin);
  printf(" burst1_freq_bin = %d\r\n", bd->burst1_freq_bin   );
  printf(" burst2_freq_bin = %d\r\n", bd->burst2_freq_bin);
  printf(" burst0_in_freq_range = %d\r\n", bd->burst0_in_freq_range);
  printf(" burst1_in_freq_range = %d\r\n", bd->burst1_in_freq_range);
  printf(" burst2_in_freq_range = %d\r\n", bd->burst2_in_freq_range);
  printf(" prev_burst_stop = %d\r\n", bd->prev_burst_stop);
  printf(" count_mwo = %d\r\n", bd->count_mwo);
  printf(" count_bts = %d\r\n", bd->count_bts);
  printf(" count_bth = %d\r\n", bd->count_bth);
  printf(" count_cph = %d\r\n", bd->count_cph);
  ...
  printf(" count_wln = %d\r\n", bd->count_wln);
  printf(" count_vbr = %d\r\n", bd->count_vbr);
  printf(" mwo_long_burst_timestamp = %d\r\n", bd->mwo_long_burst_timestamp);
  printf(" mwo_long_burst_timestamp1 = %d\r\n", bd->mwo_long_burst_timestamp1);
  printf(" mwo_long_burst_timestamp2 = %d\r\n", bd->mwo_long_burst_timestamp2);
  printf(" mwo_long_burst_frequency_bins = %d\r\n", bd->mwo_long_burst_frequency_bins);
  printf(" mwo_long_burst_frequency_bins1 = %d\r\n", bd->mwo_long_burst_frequency_bins1);
  printf(" last_report_time = %d\r\n", bd->last_report_time);
  printf(" mwo_mean_rssi = %d\r\n", bd->mwo_mean_rssi);
  printf(" cph_mean_rssi = %d\r\n", bd->cph_mean_rssi);
  printf(" bth_mean_rssi = %d\r\n", bd->bth_mean_rssi);
  printf(" bts_mean_rssi = %d\r\n", bd->bts_mean_rssi);
  printf(" cwa_mean_rssi = %d\r\n", bd->cwa_mean_rssi);
  printf(" vbr_mean_rssi = %d\r\n", bd->vbr_mean_rssi);
  printf(" wln_mean_rssi = %d\r\n", bd->wln_mean_rssi);
  printf(" average_rssi_total = %ld\r\n", bd->average_rssi_total);
  printf(" average_rssi_numbr = %d\r\n", bd->average_rssi_numbr);
  printf(" dc_in_mhz = %d\r\n", bd->dc_in_mhz);
  printf(" cph_min_freq = %d\r\n", bd->cph_min_freq);
  printf(" cph_max_freq = %d\r\n", bd->cph_max_freq);
  printf(" cwa_min_freq = %d\r\n", bd->cwa_min_freq);
  printf(" cwa_max_freq = %d\r\n", bd->cwa_max_freq);
  printf(" bts_min_freq = %d\r\n", bd->bts_min_freq);
  printf(" bts_max_freq = %d\r\n", bd->bts_max_freq);
  printf(" bth_min_freq = %d\r\n", bd->bth_min_freq);
  printf(" bth_max_freq = %d\r\n", bd->bth_max_freq);
  printf(" mwo_min_freq = %d\r\n", bd->mwo_min_freq);
  printf(" mwo_max_freq = %d\r\n", bd->mwo_max_freq);
  printf(" detects_extension_channel = %d\r\n", bd->detects_extension_channel);
  printf(" detects_control_channel = %d\r\n", bd->detects_control_channel);
  printf("  detects_below_dc = %d\r\n", bd->detects_below_dc);
  printf(" detects_above_dc = %d\r\n", bd->detects_above_dc); 
    return;
}
...
void nb_classifier(int timestamp, struct ss *bd)
{
  ...
  */
  ...
  if (something_detected == 1) {
    ...
    something_detected = 0;
    /*daniel add begin*/ 
    /* dxm 2013.8.28 13:42 [START]*/
    spectral_print_data( bd );
    /* dxm 2013.8.28 13:42 [END]*/
    /*daniel add end*/
