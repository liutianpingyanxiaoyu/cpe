...
{
    var msgw, msgh, bordercolor,titlecolor,fontcolor;
    msgw = 400; 
    msgh = 100; 
    bordercolor = "#336699"; 
    titlecolor = "#99CCFF";
    ...
    msgObj.style.font = "18px/1.6em Verdana, Bold, Geneva, Arial, Helvetica, sans-serif";
...
function mykeydown() {
    if (event.keyCode == 116) //ÆÁ±ÎF5Ë¢ÐÂ¼ü   
    {
