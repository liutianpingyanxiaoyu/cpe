...
function tbl_wrap_enable(v) {
    if (v == 1) {
        return "<img src='images/i_active_on.gif'>";
    } else {
        return "<img src='images/i_active_off.gif'>";
    }
}
...
function tbl_setup_table(T, R) {
    var c = "<table id='"+T+"_element' width='95%' border='0' align='center' cellpadding='0' cellspacing='0'>";
