...
# Add wp688 watchdog module, Sean@liteon, 2013-04-25----->
define KernelPackage/wp688-watchdog
  SUBMENU:=$(OTHER_MENU)
  TITLE:=wp688 watchdog
  KCONFIG:=CONFIG_WP688_WDT
  FILES:=$(LINUX_DIR)/drivers/wp688_watchdog/wp688_wdt.$(LINUX_KMOD_SUFFIX)
  DEPENDS:=@TARGET_ralink
  AUTOLOAD:=$(call AutoLoad,20,wp688_wdt)
endef

$(eval $(call KernelPackage,wp688-watchdog))
# <-----Sean@liteon, 2013-04-25
