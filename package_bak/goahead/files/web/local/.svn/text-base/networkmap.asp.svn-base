...
<div class="unit_title" id="unitword">WP777</div>
<!-- Hotkey"-->
...
<div class="housing" id="housing"><ul><li class="img"><a href="#"></a></li><li class="word_button"><div align="center"><a href="#">WP777</a></div></li >
</ul></div>
...
<script>                    
if (<% getCfgZero(1, "WiFiScheduleEnable"); %>  || <% getCfgZero(1, "WiFi5GScheduleEnable"); %> )
	document.write("<ul><li class='on_on' ><a href='#'></a></li><li class='off'><a href='#'></a></li></ul>");
else
	document.write("<ul><li class='on'><a href='#'></a></li><li class='off_on'><a href='#'></a></li></ul>");
</script>
...
<tr>
<td width="19" height="37"><img src="/local/advance/images/popup_top_left.gif" width="19" height="45" /></td>
<td background="/local/advance/images/popup_top_center.gif" class="table_title">WP777</td>
