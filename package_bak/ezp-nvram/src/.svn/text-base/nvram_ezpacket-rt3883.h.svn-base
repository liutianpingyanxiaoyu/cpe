...
#if ( WL_NUM == 1 )
#define WL_BASIC_RULE "1^9^0^6^1"
#define WL_AP_BASIC_RULE "1^9^0^6^1"
#if ( WL_VIRTUAL_NUM == 1 ) /* WL_IFNAME_RULE*/
#define WL_IFNAME_RULE "rai0"
#elif ( WL_VIRTUAL_NUM == 2 )
#define WL_IFNAME_RULE "rai0^rai1"
#elif ( WL_VIRTUAL_NUM == 4 )
#define WL_IFNAME_RULE "rai0^rai1^rai2^rai3"
#endif /* WL0_IFNAME_RULE*/
#define WL_RULE_NUM WL_VIRTUAL_NUM
#define WL_RULE_MAX WL_VIRTUAL_NUM
#if (WL_RULE_NUM == 2)
#warning "WL_RULE_NUM 2"
#warning "WL_RULE_MAX 2"
#elif (WL_RULE_NUM == 4)
#warning "WL_RULE_NUM 4"
#warning "WL_RULE_MAX 4"
#endif
#define WDS_RULE_MAX WL_WDS_NUM
#define APCLI_RULE_MAX WL_APCLI_NUM

#elif ( WL_NUM == 2 )
#define WL_BASIC_RULE "1^9^0^6^1|1^8^0^36^1"
#define WL_AP_BASIC_RULE "1^9^0^6^1|1^8^0^36^1"
#if ( WL_VIRTUAL_NUM == 1 ) /* WL_IFNAME_RULE*/
#define WL_IFNAME_RULE "rai0^ra0"
#elif ( WL_VIRTUAL_NUM == 2 )
#define WL_IFNAME_RULE "rai0^rai2|ra0^ra2"
#elif ( WL_VIRTUAL_NUM == 4 )
#define WL_IFNAME_RULE "rai0^rai1^rai2^rai3|ra0^ra1^ra2^ra3"
#endif /* WL_IFNAME_RULE*/
#define WL_RULE_NUM WL_VIRTUAL_NUM
#define WL_RULE_MAX WL_VIRTUAL_NUM
#define WDS_RULE_MAX WL_WDS_NUM
#define APCLI_RULE_MAX WL_APCLI_NUM
#else
#error "Amount of WLAN interfaces is error"
#endif
