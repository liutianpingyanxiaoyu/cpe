...
define BuildKernel
  ...
  compile: $(LINUX_DIR)/.modules
	...
	$(MAKE) -C $(PLATFORM_SUBDIR)/image compile TARGET_BUILD= 2>/dev/null
  ...
  install: $(LINUX_DIR)/.image
	...
	+$(MAKE) -C $(PLATFORM_SUBDIR)/image compile install TARGET_BUILD= 
  ...
  image-prereq:
	...
	@+$(NO_TRACE_MAKE) -s -C $(PLATFORM_SUBDIR)/image prereq TARGET_BUILD= 2>/dev/null
