...
#define DEFAULT_CERT_FILE	"/usr/sbin/server.pem"
#define DEFAULT_KEY_FILE	"/usr/sbin/cakey.pem"
 ...
 *	Open the socket
 */
	sslListenSock = socketOpenConnection(NULL, port, 
