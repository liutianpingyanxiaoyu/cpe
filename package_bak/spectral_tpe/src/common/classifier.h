...
/*daniel add begin*/
/* dxm 2013.9.4 15:51 [START]*/
/*#define OBSERVATION_WINDOW 1000000*/
/*#define OBSERVATION_WINDOW (int)(~0U>>1)*/
#define OBSERVATION_WINDOW 300000000
/* dxm 2013.9.4 15:51 [END]*/
/*daniel add end*/
...
#else
#define CWA_MIN_NUMBER_OF_FRAMES 4
#endif
/*daniel add end*/
...
#else
#define MWO_MIN_NUMBER_OF_FRAMES 2
#endif
/*daniel add end*/
...
#else
#define CPH_MIN_NUMBER_OF_FRAMES 2 
#endif
/*daniel add end*/
...
/* dxm 2013.9.4 15:27 [START]*/
//#define BTH_MAX_BURST_DIFF 1000
//#define BTH_MIN_PREVBURST_DIFF 3500
#define BTH_MIN_PREVBURST_DIFF 3200
#define BTH_MAX_BURST_DIFF 1300
/* dxm 2013.9.4 15:27 [END]*/
/*daniel add end*/
...
#else
#define VBR_MIN_NUMBER_OF_FRAMES 2
#endif
/*daniel add end*/
...
#define SBURST_MAX_BURSTWIDTH 800 // EVENTHOUGH THERE ARE LONGER BURSTS, WE DON'T USE THEM. WE ARE LOOKING FOR 625US BURSTS FOR UL/DL.
/* dxm 2013.9.4 16:24 [END]*/
/*daniel add end*/
...
/* dxm 2013.9.4 15:14 [START]*/
//#define SINGLE_FREQUENCY_MAX_BINSPAN 3
#define SINGLE_FREQUENCY_MAX_BINSPAN 5
/* dxm 2013.9.4 15:14 [END]*/
/*daniel add end*/
