...
# Add ethernet module, Sean@liteon, 2013-04-28----->
define KernelPackage/ethernet-wr8401
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=wr8401 ethernet support
  DEPENDS:= @TARGET_atheros
  KCONFIG:=CONFIG_ATHRS_GMAC
  FILES:=$(LINUX_DIR)/drivers/net/ar934x/athrs_gmac.ko
  AUTOLOAD:=$(call AutoLoad,60,ethernet-wr8401)
endef

define KernelPackage/ethernet-wr8401/description
 Kernel module for ethernet on wr8401
endef

$(eval $(call KernelPackage,ethernet-wr8401))
# <-----Sean@liteon, 2013-04-28

# Add ethernet module, Daniel@liteon, 2013-10-25----->
define KernelPackage/ethernet-wp838
  SUBMENU:=$(NETWORK_DEVICES_MENU)
  TITLE:=wp838 ethernet support
  DEPENDS:= @TARGET_atheros
  KCONFIG:=CONFIG_ATHRS_GMAC
  FILES:=$(LINUX_DIR)/drivers/net/ethernet/athrs_gmac.ko
  #AUTOLOAD:=$(call AutoLoad,61,ethernet-wp838)
  AUTOLOAD:=$(call AutoLoad,61,athrs_gmac)
endef

define KernelPackage/ethernet-wp838/description
 Kernel module for ethernet on wp838
endef

$(eval $(call KernelPackage,ethernet-wp838))
# <-----Daniel@liteon, 2013-10-25
