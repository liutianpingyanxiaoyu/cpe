...
#define ATH_GMAC_POLL_LINK_FREQ (HZ/2)  /*speed up poll frequecy for workaround: 1000M negotiate to 100M issue. Peter, 2012-03-31*/
...
#endif
/*Added by Bruce Liu. 2012-03-24*/
        case P1020_ETH_CONFIG:
            ret = athr_phy_mii(dev,ifr);
            break;
/*End by Bruce*/
        default:
           break;
