...
# Add for select_sdk_liteon_branch, Sean@liteon.com, 2013-04-25
LITEON_SRC_FLAG:=LITEON_SRC_VALID
ifneq ($(CONFIG_TARGET_ralink),)
TARGET_CC:=$(TARGET_CROSS)gcc -D$(LITEON_SRC_FLAG)
else
